...
106. spring 事务实现
     ...
     ![143421_Bmpa_1452390.png (1716×1288)](/github/northernw.github.io/image/143421_Bmpa_1452390.png)
     ...
     ![143554_iORI_1452390.png (2401×2029)](/github/northernw.github.io/image/143554_iORI_1452390.png)
...
111. synchronized底层实现，加在方法上和加在同步代码块中编译后的区别、类锁、对象锁
     ...
     加载同步块上：monitorenter / monitorexit 关键字 
...
112. volatile在编译上的体现
     ...
     体现是aload_0？使用前从主存重新加载？--- 网上查到的是变量上flags有ACC_VOLATILE标识，自己编译出来没看到...
